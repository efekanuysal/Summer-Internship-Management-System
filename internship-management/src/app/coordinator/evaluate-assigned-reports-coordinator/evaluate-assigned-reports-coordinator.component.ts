...
@Component({
  selector: 'app-evaluate-assigned-reports-coordinator',
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './evaluate-assigned-reports-coordinator.component.html',
  styleUrl: './evaluate-assigned-reports-coordinator.component.css'
})
export class EvaluateAssignedReportsCoordinatorComponent implements OnInit{
